<footer class="main-footer dt-sl">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="widget-menu widget card">
                        <header class="card-header">
                            <h3 class="card-title">راهنمای خرید از فستیوال گیم</h3>
                        </header>
        ...
        <div class="container main-container">
            <div class="row">
                <div class="site-description col-12 col-lg-7">
                    <h1 class="site-title">فروشگاه اینترنتی فستیوال گیم، بررسی، انتخاب و خرید آنلاین</h1>
                    <p>
                        فستیوال گیم به عنوان یکی از قدیمی‌ترین فروشگاه های اینترنتی با بیش از یک دهه تجربه، با
                        ...
                        اینترنتی ایران تبدیل شود. به محض ورود به فستیوال گیم با یک سایت پر از کالا رو به رو
    ...
    <div class="copyright">
        <div class="container main-container">
            <p>
                استفاده از مطالب فروشگاه اینترنتی فستیوال گیم فقط برای مقاصد غیرتجاری و با ذکر منبع بلامانع است.
                کلیه حقوق این سایت متعلق
                به فستیوال گیم می‌باشد.
            </p>
        </div>
    </div>
</footer>
