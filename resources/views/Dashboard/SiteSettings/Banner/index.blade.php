                ...
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-12 col-12 mx-auto">
                            <form action="{{route('Dashboard.SiteSettings.Banner.Create')}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control" name="Position"
                                               @if(old('Position')) value="{{old('Position')}}" @endif
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label for="MainImage">عکس بنر</label>
                    ...
                    <table id="zero-config" class="table table-hover" style="width:100%">
                        ...
                        @foreach($Banners as $banner)
                            <tr>
                                ...
                                <td><a href="{{rawurldecode($banner->Link)}}" target="_blank" class="text-info"> {{__($banner->LinkTo , [] , 'fa')}} </a></td>

                                <td>
                                    <a href="{{route('Dashboard.SiteSettings.Banner.Edit' , $banner->id)}}">
